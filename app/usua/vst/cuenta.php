...
<?php foreach($musuarios->poride($s_usua_ide) as $r): ?>
	<form action="" class="op2 form-horizontal">
		<?php echo $fn->modalHeader('Editar Perfil de Usuario') ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<select name="nac" id="" class="form-control">
						<option value="V" <?php echo $fn->select('V',$r->usua_naciona) ?>>Venezolano</option>
						<option value="E" <?php echo $fn->select('E',$r->usua_naciona) ?>>Extranjero</option>
						<option value="P" <?php echo $fn->select('P',$r->usua_naciona) ?>>Pasaporte</option>
						<option value="J" <?php echo $fn->select('J',$r->usua_naciona) ?>>Jurídico</option>
					</select>
				</div>
				<div class="col-sm-5">
		...
		<!--<div class="form-group">
				...
				<div class="col-sm-8">
					<select disabled name="tip" id="" class="form-control">
						<option value=""></option>
