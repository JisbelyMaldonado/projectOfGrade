...
<?php $est = $mespa->lista($_POST['parque']) ?>

<?php echo $fn->modalWidth('80%') ?>
<?php echo $fn->modalHeader('Información') ?>
  <div class="modal-body">
    <div class="tabbable">
        ...
        <div class="tab-content">
            ...
            <div id="esta" class="tab-pane">
                <p>
                    <?php if(count($est)>0): ?>
                       <table class="table table-striped">
                           <?php foreach($est as $r): ?>
                                <tr>
                                    <td>
                                        <i class="fa fa-check"></i> 
                                        <?php echo $r->esta_descrip ?>  <?php echo $r->muni_descrip ?>
                                    </td>
                                </tr>
                           <?php endforeach; ?>
                       </table>
