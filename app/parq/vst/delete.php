...
<?php foreach($mparq->poride($ide) as $r): ?>
	<form action="" class="op3">
		<?php echo $fn->modalHeader('Eliminar Parque'); ?>
		<div class="modal-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-12">
					<input disabled type="text" class="form-control" name="des" value="<?php echo $r->parq_nombre ?>">
				</div>
			</div>
		</div>
	...
	$(function() { 
		...
		$(formulario).validate({
			...
			submitHandler: function (form) {
				$.post('prc-mparq-delete',$(formulario).serialize(),function(data){
					if(data==1) {
